...
# configurations
img_folder = '/home/achraf/Downloads/BasicSR/codes/data/HR_subimages/*'  # glob matching pattern
lmdb_save_path = '/home/achraf/Downloads/BasicSR/codes/data/HR_subimages.lmdb'  # must end with .lmdb
